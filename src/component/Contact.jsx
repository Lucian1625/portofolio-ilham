...
const Contact = () => {
  ...
  return (
    <>
      <div className='h-screen md:h-auto bg-gradient-to-r bg-blue-kc lg:from-blue-kc lg:via-blue-kc lg:to-cyan-700 relative' id='Contact'>

        <div className="h-screen text-rose-white lg:text-5xl text-2xl lg:text-left text-center ">

          <div className='p-10 text-xl buttom-10 top-6'>Contact Information</div>
        ...
        <div className="absolute z-20 shadow-lg bg-white/30 top-[20%] lg:top-[5%] backdrop-blur-sm rounded-lg right-[2%] h-[77%] lg:h-[90%] w-[96%] lg:w-[60%]">
          ...
          <div className="w-full h-20 rounded-lg bg-blue-kc/30">
          ...
          <form action="" method="get" >
            <div className="block lg:flex p-10">
              ...
              <input type="text" placeholder='Your Name' className="mt-1 block w-[100%] lg:w-[50%] mr-6 px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
      ...
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500"/>
              ...
              <input type="text" placeholder='Your Email' className="mt-10 lg:mt-1 block w-[100%] lg:w-[50%] px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
      ...
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500"/>
              ...
              <div className="relative px-10">
                <Listbox.Button className="relative w-full cursor-default rounded-lg bg-white py-2 pl-3 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm">
                  ...
                  <span className="pointer-events-none absolute inset-y-0 right-0 hover:rotate-90 flex items-center pr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" aria-hidden="true" fill="currentColor" className="w-5  h-5">
                  ...
                  <Listbox.Options className="absolute mt-1 align-items-right max-h-60 w-[50%] overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                    {country.map((country, countryIdx) => (
                      ...
                      placeholder='Your Country'
                        key={countryIdx}
                        className={({ active }) =>
                          `relative cursor-default select-none py-2 pl-10 pr-4 ${active ? 'bg-amber-100 text-shushime' : 'text-gray-900'
                          }`
                        }
                        value={country}
                      >
            ...
            <div className="h-80 px-10">
              ...
              <textarea name="" className='focus:border-sky-500 resize-none focus:ring-1 focus:ring-sky-500 w-full rounded-lg h-[60%] bg-white' id="" cols="30" rows="10"></textarea>
      ...
      <div className="w-full h-6 bg-white">
        <div className='text-black antialiased text-center'>©2022 Ilham Ahsan Saputra All Right Reserved</div>
      </div>
    </>
  )
}
