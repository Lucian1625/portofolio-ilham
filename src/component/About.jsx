...
const About = () => {
  ...
  return (
    <>
      <div id="About" className='grid-rows-3 grid-flow-col top-0 w-full lg:h-auto h-96 z-40 bg-blue-kc grid grid-cols-3'>
        ...
        <div className='row-span-3 h-full bg-blue-kc/10'>
          <div className="h-full p-1 z-0 rounded-none">
            <div className="h-full py-8">
              <img src={Image2} alt="" className='h-full lg: rounded-full' />
            </div>
          </div>
        </div>
        {/* description bio */}
        <div className="row-span-3 px-3 py-6 text-rose-white col-span-2 lg:p-16 place-items-center">
          <div className='lg:mt-12 mt-0 bold lg:text-2xl text-shushime'>Bio</div>
          <div className='lg:text-5xl my-4'>{sectionAbout}</div>
          <div className="lg:text-xl mt-2">{dectipsidiri}</div>
          ...
          <div className="hidden p-6 mt-12">
            <div className='flex'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-2 text-shushime mr-1 h-2 lg:w-5 lg:h-6">
